...
% (c) 2017 Ricardo Decal <decal-at-uw.edu> http://www.ricardodecal.com
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \vspace{-1em}
%\ressubheading{Owner and Creator Assistant}{Seattle, WA}{Light Recycled}{Oct. 2014 $\rightarrow$ Jan. 2016}
...
%\end{itemize}
    ...
    \textbf{Machine Learning Researcher}, \textit{Latent Health} \hfill 2026 --- Now \\
    Training AI models to modernize healthcare.

    \textbf{Machine Learning Engineer}, \textit{Anyscale} \hfill 2025 --- 2026 \\
    Conceived, pitched, and leading \textbf{Ray-bench}: a benchmark for LLM agents on distributed-systems code, paired with \textbf{RayGym}, a sandboxed multi-node execution harness for code-RL post-training. Also designing an RL environment for a Ray Core resource auto-calibration model. Engineered scalable distributed Ray implementations of GRPO post-training, LLM-as-judge data curation, 670B-parameter LLM serving, multimodal training, and agentic workflows.

    \textbf{Lead Machine Learning Engineer}, \textit{Dendra Systems} \hfill 2020 --- 2025 \\
    Founding ML lead. Built end-to-end systems for long-tailed open-world inference across thousands of classes: data engine, training infrastructure, MLOps. Highlights: 60\% training-data reduction via novelty-maximizing data pruning (original research); 20$\times$ training-cost reduction via Bayesian hyperparameter tournaments; 80$\times$ acceleration in insights delivery via model-in-the-loop annotation tooling.

    \textbf{Lead Data Scientist}, \textit{PaceMate} \hfill 2019 \\
    Solo ML hire. Took cardiac arrhythmia detection from zero to deployed deep-learning system in a regulated, life-critical pipeline; end-to-end ownership across data, modeling, clinician tooling, and SOC2 security.
    ...
    POC deep reinforcement learning for neuron tracing of Pb-scale brain microscope data (\href{https://www.ricardodecal.com/projects/profundo-an-rl-agent-for-neural-cell-tracing/}{\textit{Profundo} writeup}).
...
%      \end{tabularx}
    ...
    %
    %\ressubheading{\hypertarget{Mosquitogrant}Multisensory Integration in Mosquitos}{Seattle, WA}{Fairhall Lab, University of Washington}{Oct. 2014 $\rightarrow$ Now}
