...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \item	Created tutorials for large-scale distributed AI workloads. Examples include post-training LLMs using GRPO, data curation using LLM-as-judge, serving 670B parameter LLMs, multimodal models, agentic workflows.
    \item	Designed benchmarks to compare performance and cost across Ray OSS and RayTurbo.

	\item   Creating an RL environment and generated data for a Ray Core resource auto-tuning agent.
    \end{itemize}
