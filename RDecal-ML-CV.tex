...
% (c) 2011 Ricardo Decal <richard.decal at ncf edu> http://www.richarddecal.com
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \vspace{-6pt} Anyscale is a cloud ML platform for scaling Ray Distributed workloads.

    \begin{itemize}
        \item Product manager for Ray Train and Ray Tune.
        \item Created end-to-end tutorials for scalable ML pipelines, spanning data ingestion, training, evaluation, and deployment.
    \end{itemize}
