...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    I'm a self-starting Machine Learning Engineer, proficient in full-lifecycle and 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \vspace{-6pt} Anyscale is a cloud platform for scaling heterogeneous AI workloads. I work on various LLM-related initiatives.
    \begin{itemize}
    \item   Dogfooded new features in Ray LLM and Ray Direct Transport.
    \item	Created tutorials for large-scale distributed AI workloads. Examples include RL post-training LLMs using GRPO, data curation using LLM-as-judge, serving 670B parameter LLMs, multimodal models, agentic workflows.
    \item	Designed benchmarks to compare performance and cost across Ray OSS and RayTurbo.

	\item   Created an RL environment to train a Ray Core resource auto-calibration model.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Devised unsupervised ``trip-wires'' for detecting model hallucinations in production. Integrated alerts into project tracker for strategic annotation team so that we can proactively fix the issue (\texttt{Jira}).
            ...
            \item Collaborated with ecologists to create model failure reports and gain intuition for model hallucinations. Created data collection campaigns to patch biases in training data.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    * 2025 Various blog posts and tutorials on Ray, LLMs, and ML. Selected examples: \textit{\href{https://www.anyscale.com/blog/deepseek-vllm-ray-google-kubernetes}{Deploy DeepSeek‑R1 with vLLM and Ray Serve on Kubernetes}}, \textit{\href{https://www.anyscale.com/blog/ray-direct-transport-rdma-support-in-ray-core}{Ray Direct Transport RDMA Support in Ray Core}}.

    * 2025 Speaker at various Ray meetups:
    \href{https://luma.com/u5p41kte}{Daft+Ray}, vLLM+Ray, Skypilot+Ray.
