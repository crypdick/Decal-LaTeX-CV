...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Team lead experienced with 0-to-1 bootstrapping of ML teams, ML products, data collection teams, and data collection products.
...
% 
    ...
    \begin{itemize}
        \item Single-threaded owner of ML roadmap (aligned with product roadmap). Charted priorities, KPIs, and OKRs. Wrote project charters, design docs, SWOT analyses, effort-value matrices.  Led Agile sprints.
        ...
        \begin{itemize}
            ...
            \item Wrote hooks to enable observability into our pipelines (\texttt{AWS Cloudwatch, AWS Lambda, Slackbots, UMAP, Altair}). Presented incidents at weekly Operational Excellence meetings.
            \item Led initiative to automate and systematize all workflows (\texttt{custom orchestrator}).
