...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    * Invited talk \textit{New College of FL}: \textit{Remote Sensing of Cardiac Arrhythmia at Scale using Deep Learning}.

    * 2019 Invited talk \textit{Escuela Secundaria Tecnica de Torquinst}: \textit{Intelligencia Artificial}.
