...
\vspace{-6pt} Implemented proof of concept for automatically tracing brain cell morphologies using deep reinforcement learning.\\ % These models will be further validated using electrophysiological \& tethered flight data to test theories about multi-modal decision making.\\
