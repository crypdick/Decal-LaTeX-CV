...
\textbf{\Large Richard Boeri Decal}, Molecular biologist & \emailsymbol  \href{mailto:richard.decal@ncf.edu}{richard.decal@ncf.edu} \\
\textit{updated \today} & \homepagesymbol \href{www.RichardDecal.com}{www.RichardDecal.com}  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \textsc{Computer}
        ...
        \item[Programming] Fluent: Bash and \LaTeX. Novice: Python, MySQL, NumPy, MATLAB, and Arduino.% sequence alignment.
        \end{description}
        
    \textsc{Personal}}
        \begin{description}\setlength{\itemsep}{0mm}
        \item[Photography] I am proficient at DSLR photography and Adobe image manipulation software (\href{https://plus.google.com/photos/102379214640133460120/albums}{portfolio}).
        \item[Other] Well-rounded, passionate, and dedicated. Fluent in English and Spanish. Known to dabble in the kitchen. I've played violin, piano, contrabass, and ukulele. Licensed scuba diver.
        \end{description}
