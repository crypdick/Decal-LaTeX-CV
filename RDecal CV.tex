...
I created agent-based dynamical models of mosquito flight behavior and benchmark the models against wind-tunnel behavioral data.\\ % These models will be further validated using electrophysiological \& tethered flight data to test theories about multi-modal decision making.\\
