...
\resheading{Education}
    ...
    \ressubheading{New College of Florida}{Sarasota, FL}{M.S. Data Science.}{Aug. 2017 --- Now}

    \ressubheading{Artificial Intelligence Engineer}{Udacity.com}{Nanodegree.}{Feb. 2017 --- May 2017}

    \ressubheading{University of Washington}{Seattle, WA}{Post-baccalaureate researcher.}{Oct. 2014 --- Jan. 2016}
 
    \ressubheading{New College of Florida}{Sarasota, FL}{B.A., Chemistry/Biology (with honors).}{Aug. 2007 --- May 2011}

    \ressubheading{Harriet L. Wilkes Honors College}{Jupiter, FL}{Early admission in lieu of a high school senior year.}{Sep. 2006 --- May 2007}
...
\ressubheading{Automated Tracing of Neurons}{Seatle, WA}{Allen Institute for Brain Science}{June 2018 --- Now}

\vspace{-6pt} I am using deep reinforcement learning to massively parralelize brain cell tracing.\\ % These models will be further validated using electrophysiological \& tethered flight data to test theories about multi-modal decision making.\\



\ressubheading{\hypertarget{Mosquitogrant}Multisensory Integration in Mosquitos}{Seatle, WA}{Fairhall Lab, University of Washington}{Oct. 2014 --- Now}

\vspace{-6pt} I created agent-based dynamical models of mosquito plume-seeking behavior using wind-tunnel flight data.\\ % These models will be further validated using electrophysiological \& tethered flight data to test theories about multi-modal decision making.\\
    

\ressubheading{\hypertarget{whalevolunteering}Humpback Whale Census}{James Price Point, Australia}{Kimberley Community Whale Research Project}{Aug. 2012 --- Oct. 2012}

\vspace{-6pt} A community-initiated peer-review of a study conducted by an oil conglomerate at the proposed site of the world's second-largest liquefied gas processing port. Our research revealed gross discrepancies in the original study.\\ %old link\href{http://tinyurl.com/JPP-humpback-whale-survey-2013}{peer-review}'s

    \ressubheading{Honors Baccalaureate Thesis}{Sarasota, FL}{Walstrom Lab, New College of Florida}{Aug. 2010 --- May 2011}

\vspace{-6pt} My capstone \hyperlink{thesispub}{thesis project} proposes a model for RNA Helicase A function in endogenous \emph{C. elegans} RNAi pathways based on qRT-PCR experiments.\\ % My baccalaureate exam was administered by a committee of faculty and consisted of a thesis defense followed by a comprehensive oral exam covering all courses I took at New College.\\

    \ressubheading{Tutorials}{Sarasota, FL}{New College of Florida}{Aug. 2007 --- May 2011}
...
\vspace{-6pt} I created courses with faculty supervision using New College's tutorial system. Highlights: ``Quantitative RT-PCR", ``Floridian Invasive Species", and ``Synthesis of P450".\\
    ...
    \ressubheading{Genomics Outreach for Minorities Project (NSF-REU)}{Seattle, WA}{Pallanck Lab, University of Washington}{May 2010 --- Aug. 2010}
...
\vspace{-6pt} I partially synthesized precursors to a novel high-valent iron-stabilizing macrocycle based on the active site of cytochrome P450.\\

    \ressubheading{Summer Undergraduate Research Program (NSF-REU)}{Pittsburgh, PA}{McCartney Lab, Carnegie Mellon University}{May 2009 --- Aug. 2009}

\vspace{-6pt} I determined that APC2, a protein with probable roles in colon cancer tumorogenesis, did not interact with $\beta$-catenin of the Wnt pathway's destruction complex. I determined that APC2's conserved N-terminal domain was not essential for its proper localization. This research was \hyperlink{carnegiepub}{published} in \textit{Genetics}.\\
...
\resheading{Awards, Grants \& Honors}
     \ressubheading{Full tuition waver for master's program}{}{New College of Florida}{Aug. 2017 --- Now}
