...
Researcher in Dr.\ Adrienne Fairhall's lab. I create dynamical models of mosquitos tracking turbulent thermal plumes and benchmark the models against wind-tunnel behaviorioral data. These models will be further validated using electrophysiological \& tethered flight data to test theories about multi-modal decision making.\\
...
%    Routine duties for the department, including autoclaving and disposing lab waste, preparing and sterilized solutions and agar plates, and preparing lab courses as needed. \\
    ...
    A 10-week project conducted in Dr.\ Brooke McCartney's lab. I determined that APC2, a protein with probable roles in colon cancer tumorogenesis, did not interact with $\beta$-catenin of the Wnt pathway's destruction complex. I determined that APC2's conserved N-terminal domain was not essential for its proper localization. This research was \hyperlink{carnegiepub}{published} in \textit{Genetics}.\\
...
\resheading{Teaching}
    ...
    \ressubheading{Brain Awareness Week 2015}{Seattle, WA}{University of Washington}{March 2015}
