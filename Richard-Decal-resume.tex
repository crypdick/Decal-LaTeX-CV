...
{\small \faMapMarker~ Sarasota, FL, USA $\cdot$ \faPhone~ (+1) 48-448-DECAL $\cdot$ \faEnvelope~ \href{mailto:richard.decal@ncf.edu}{richard.decal@ncf.edu}  \\ \faGithubAlt~ \href{https://github.com/crypdick}{crypdick}   $\cdot$ ~\faLinkedin~ \href{https://www.linkedin.com/in/richarddecal/}{richarddecal}  $\cdot$~\faStackOverflow~  \href{https://stackoverflow.com/users/4212158/crypdick}{crypdick} $\cdot$  ~\faHome~  \href{http://www.richarddecal.com}{richarddecal.com} $\cdot$ 
 \tiny{\textit{updated \Today}}}
\end{center}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\vspace{-1em}
\resheading{~~Skills \hfill {\small$^+$ denotes proficiency}}%\vspace*{0.5em}

\textbf{Languages} Python$^+$   $\cdot$ R $\cdot$ SQL $\cdot$ BASH $\cdot$ Espa\~nol$^+$ $\cdot$ English$^+$ $\cdot$ Italiano

\textbf{Packages} Tensorflow  $\cdot$ Pandas$^+$ $\cdot$ Numpy$^+$ $\cdot$ Scikit-learn   $\cdot$ \mbox{Matplotlib}$^+$

\textbf{Passions} Travel, teaching, learning, social justice, tiny living. Research interests: molecular biology, climate science, computational neuroscience, +++.

%\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
%  \bfseries{Languages} & Python$^+$   $\cdot$ R $\cdot$ SQL \\
%  \bfseries{Packages} & Tensorflow  $\cdot$ Pandas$^+$ $\cdot$ Numpy$^+$ $\cdot$ Scikit-learn   $\cdot$ \mbox{Matplotlib}$^+$  \\
%  %\bfseries{OS} & Linux$^\star$ $\cdot$ MS Windows$^\star$ $\cdot$  Mac OS X$^\star$ $\cdot$ Android$^\star$ $\cdot$ iOS  \\
%  \bfseries{Misc.} &  systems$^+$ \\ %$\cdot$ \LaTeX$^+$ \\  % Web data scraping USA/EU Dual-citizen
%  \bfseries{Passions} & Travel, teaching, learning, social justice, tiny living. Research interests: molecular biology, climate science, computational neuroscience, +++.
%\end{tabularx}
...
%\vspace{-1em}
\textbf{\href{https://github.com/crypdick/policy-gradients-cartpole}{CartPole}} I solved \href{https://gym.openai.com/envs/CartPole-v0}{CartPole} (a continuous classic control game) using policy gradients.

\textbf{\href{https://github.com/crypdick/predict-donors-California-census}{CA Income \mbox{Prediction}}} Predicted incomes using \href{https://www.aaai.org/Papers/KDD/1996/KDD96-033.pdf}{California census data} based on 14 characteristics using feature engineering, support vector machines, and cross-validation.

\textbf{\href{https://github.com/crypdick/RoboSkeeter}{Roboskeeter}\mbox{\textnormal{\textit{(ongoing)}}}}   Modeling mosquito heat-tracking behavior during foraging based on windtunnel experimental data.
%
%\setlength{\extrarowheight}{.5em}
%\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
%\bfseries{\href{https://github.com/crypdick/policy-gradients-cartpole}{CartPole}} & I solved \href{https://gym.openai.com/envs/CartPole-v0}{CartPole} (a continuous classic control game) using policy gradients.\\
%
...
%
%\bfseries{\href{https://github.com/crypdick/RoboSkeeter}{Roboskeeter}}  \mbox{\textnormal{\textit{(ongoing)}}} &  Created models of mosquito heat-tracking behavior during foraging from windtunnel experimental data.
%\end{tabularx}
...
%\end{itemize}
\textbf{Dept. of Biophysics, Uni. of Washington: Research Assistant} \hfill 2014 $\rightarrow$ 2016

Simulated mosquito thermonavigation (data munging, design, coding, visualization, analysis). Learned concepts in neuronal dynamics which are relevant to artificial deep neural networks.

%\ressubheading{Research Assistant}{Seattle, WA}{Fairhall Lab, Dept. of Biophysics, Uni. of Washington}{2014 $\rightarrow$ 2016}
%
%\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, nolistsep] \vspace{-10pt}
%\item Simulated mosquito thermonavigation (data munging, design, coding, visualization, analysis).
...
``\href{http://www.pnas.org/content/early/2012/06/12/1120688109}{Analysis of neural subtypes reveals selective mitochondrial dysfunction in dopaminergic neurons from parkin mutants}". \textit{PNAS} 2012. 109(26):10438-43.

``\href{http://www.genetics.org/content/190/3/1059.full}{Destruction Complex Function in the Wnt Signaling Pathway of Drosophila Requires Multiple Interactions Between Adenomatous Polyposis Coli 2 and Armadillo}". \textit{Genetics} 2012. 190(3):1059-75.

``Quantifying Small RNA Concentrations in \textit{C. elegans}". Honors thesis. 2011.
...
\textbf{M.S. Data Science}, \textit{New College of Florida.} \hfill 2019

\textbf{Artificial Intelligence Engineer Nanodegree}, \textit{Udacity \& Kaggle} \hfill 2017
