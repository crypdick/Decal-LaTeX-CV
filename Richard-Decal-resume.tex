...
%\lhead{\faMapMarker~~ St. Petersburg, USA \\
...
\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
  \bfseries{Algorithms} & Regression   $\cdot$  Clustering  $\cdot$ Gradient descent$^\star$ $\cdot$ Cross-validation    $\cdot$  PCA $\cdot$ Neural networks   $\cdot$  \mbox{Neural style transfer$^\star$} \\
