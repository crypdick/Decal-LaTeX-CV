...
\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
  \bfseries{Algorithms} & Supervised, unsupervised, and reinforcement learning $\cdot$ Cross-validation    $\cdot$  PCA \\
  ...
  \bfseries{Misc.} & Espa\~nol$^+$ $\cdot$ English$^+$ $\cdot$ Italiano  $\cdot$ UNIX systems$^+$ \\ %$\cdot$ \LaTeX$^+$ \\  % Web data scraping USA/EU Dual-citizen
...
\textbf{M.S. Data Science}, \textit{New College of Florida. Expected 2019.} \hfill Sarasota, FL
