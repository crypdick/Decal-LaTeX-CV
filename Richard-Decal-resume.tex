...
\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
  ...
  \bfseries{Passions} & Travel, teaching, learning, social justice, my tiny home. Research interests: machine learning, molecular biology, climate science, computational neuroscience.
\end{tabularx}
