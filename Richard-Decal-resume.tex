...
\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
  ...
  \bfseries{Misc.} & Espa\~nol$^+$ $\cdot$ English$^+$ $\cdot$ Italiano  $\cdot$ UNIX systems$^+$  \\  % Web data scraping USA/EU Dual-citizen
  \bfseries{Passions} & Travel, teaching, learning, social justice, tiny living. Research interests: molecular biology, climate change, computational neuroscience, +++.\\
\end{tabularx}
...
\item Responsible for simulating experiments (data munging, design, coding, visualization, analysis).
