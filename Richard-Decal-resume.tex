...
\begin{tabularx}{\textwidth}{p{3cm}>{\arraybackslash}X}
  \bfseries{Algorithms} & Supervised, unsupervised, and reinforcment learning $\cdot$ Cross-validation    $\cdot$  PCA \\
  ...
  \bfseries{Research} &  Experienced in computational neuroscience, biochemistry, and genetics research. I am co-author on several peer-reviewed publications.\\
  \bfseries{Misc.} & Espa\~nol$^+$ $\cdot$ English$^+$ $\cdot$ Italian  $\cdot$ UNIX systems$^+$  \\  % Web data scraping USA/EU Dual-citizen
