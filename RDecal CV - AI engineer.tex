...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{~\faTerminal~ Skills \hfill \small{Novice \OneBar $\cdot$ Intermediate \TwoBar $\cdot$ Proficient \ThreeBar $\cdot$ Master \faStar}}


{\ffmfamily\bfseries{Algorithms}} Regression \OneBar $\cdot$ gradient descent \TwoBar $\cdot$ cross-validation \OneBar $\cdot$ neural style transfer \ThreeBar \\
 {\ffmfamily\bfseries{Languages}} Python \ThreeBar $\cdot$ Shell scripting  \OneBar \\
{\ffmfamily\bfseries{Programming}} Pandas  \TwoBar $\cdot$ Numpy  \TwoBar $\cdot$ Scikit-learn  \OneBar $\cdot$ Matplotlib  \ThreeBar $\cdot$ Git  \TwoBar $\cdot$ Unix CLI  \TwoBar \\
{\ffmfamily\bfseries{Research}} I have been a researcher in the fields of computational neuroscience, biochemistry, genetics, and marine biology. I am co-author on several peer-reviewed scientific publications.\\

       % \item[Software] Proficient: office suites, image manipulation and analysis software, and other common productivity packages.
       % \item[Operating Systems] Proficient: Linux, MS Windows, Mac OS X, iOS, and Android.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{~\faCodeFork~ Projects} % \& Employment
...
\end{itemize}
 ...
 %Manuscript I create agent-based dynamical models of mosquito flight behavior and benchmark the models against wind-tunnel behavioral data.\\
