...
{\Huge Richard Boeri Decal} \\  %TODO: make nicer
...
\begin{tabularx}{\textwidth}{p{3.5cm}>{\arraybackslash}X}
  ...
  \bfseries{Misc.} & Espa\~nol \ThreeBar $\cdot$ English \FourBar $\cdot$ Italian \TwoBar  $\cdot$ Mandarin \OneBar  $\cdot$ Technical writing \TwoBar  $\cdot$  Photoshop \& Lightroom \ThreeBar  $\cdot$ Algorithmic trading \OneBar \\  % Web data scraping USA/EU Dual-citizen
