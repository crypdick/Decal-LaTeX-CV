...
\newcommand{\github}{%
\begin{tikzpicture}[y=0.30pt, x=0.3pt,yscale=-1, inner sep=0pt, outer sep=0pt,opacity=1.]
...
\textit{updated \today} & \github{\href{https://github.com/crypdick/}{crypdick}} \faLinkedin%   \\
