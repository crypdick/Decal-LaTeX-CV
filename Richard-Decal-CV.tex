...
\begin{tabularx}{\textwidth}{p{3.5cm}>{\arraybackslash}X}
\bfseries{\href{https://github.com/crypdick/RoboSkeeter}{Roboskeeter}} & Created models of mosquito decision-making. Coded in Python using Numpy, Pandas, Matplotlib, and Scipy.
\end{tabularx}
